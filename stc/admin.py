...
from .models import StcProfile, Stc
...
# D - StcProfile Admin #
@admin.register(StcProfile)
class StcProfileAdmin(DjangoAdminOnlyMixin, admin.ModelAdmin):
...
# E - Stc Admin #
@admin.register(Stc)
class StcAdmin(DjangoAdminOnlyMixin, admin.ModelAdmin):
    list_display = ['project_name_stc', 'supplier_name_stc', 'created_by', 'team', 'created_at']
    list_filter = ['team', 'created_by']
    search_fields = [
        'project_name_stc__name_of_project',
        'supplier_name_stc__name_of_supplier',
