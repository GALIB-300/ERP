...
from .models import PoProfile, Po
...
# D - PoProfile Admin #
@admin.register(PoProfile)
class PoProfileAdmin(DjangoAdminOnlyMixin, admin.ModelAdmin):
...
# E - Po Admin #
@admin.register(Po)
class PoAdmin(DjangoAdminOnlyMixin, admin.ModelAdmin):
    list_display = ['project_name_po', 'supplier_name_po', 'created_by', 'team', 'created_at']
    list_filter = ['team', 'created_by']
    search_fields = [
        'project_name_po__name_of_project',
        'supplier_name_po__name_of_supplier',
