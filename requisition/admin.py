...
class RequisitionProfileAdmin(DjangoAdminOnlyMixin, admin.ModelAdmin):
...
class RequisitionAdmin(DjangoAdminOnlyMixin, admin.ModelAdmin):
    list_display = ['project_name_requisition', 'requisition_no', 'created_by', 'team', 'created_at']
    list_filter = ['team', 'created_by']
    search_fields = ['project_name_requisition__name_of_project', 'requisition_no', 'created_by__username']
    ordering = ['-created_at']
