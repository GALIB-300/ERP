...
class PrProfileAdmin(DjangoAdminOnlyMixin, admin.ModelAdmin):
...
# E - Pr Admin #
@admin.register(Pr)
class PrAdmin(DjangoAdminOnlyMixin, admin.ModelAdmin):
    list_display = ['project_name_pr', 'resource_name_pr', 'created_by', 'team', 'created_at']
    list_filter = ['team', 'created_by']
    search_fields = [
        'project_name_pr__name_of_project',
        'resource_name_pr__name_of_resource',
