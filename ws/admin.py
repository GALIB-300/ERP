...
from .models import WsProfile, Ws
...
# D - WsProfile Admin #
@admin.register(WsProfile)
class WsProfileAdmin(DjangoAdminOnlyMixin, admin.ModelAdmin):
...
# E - Ws Admin #
@admin.register(Ws)
class WsAdmin(DjangoAdminOnlyMixin, admin.ModelAdmin):
    list_display = [
        'project_name_ws',
        'task_name_ws',
        'created_by',
    ...
    list_filter = ['team', 'created_by']   # ✅ corrected field name
    search_fields = [
        'project_name_ws',
        'task_name_ws',
