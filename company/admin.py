...
# D - CompanyProfile Admin #
@admin.register(CompanyProfile)
class CompanyProfileAdmin(DjangoAdminOnlyMixin, admin.ModelAdmin):
...
class CompanyAdmin(DjangoAdminOnlyMixin, admin.ModelAdmin):
    list_display = ['company_name', 'company_address', 'created_by', 'team', 'created_at']
    list_filter = ['team', 'created_by']  # ✅ lowercase fields
    search_fields = ['company_name', 'company_address', 'created_by__username']
    ordering = ['-created_at']
